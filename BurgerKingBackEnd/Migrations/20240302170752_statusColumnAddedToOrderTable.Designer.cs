...
namespace BurgerKingBackEnd.Migrations
{
    ...
    [Migration("20240302170752_statusColumnAddedToOrderTable")]
    partial class statusColumnAddedToOrderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BurgerKingBackEnd.Entities.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BurgerKingBackEnd.Entities.Courier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BurgerKingBackEnd.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CardItemOrder", b =>
                {
                    b.Property<int>("OrdersId")
                        .HasColumnType("int");

                    b.Property<int>("cardItemsId")
                        .HasColumnType("int");

                    b.HasKey("OrdersId", "cardItemsId");

                    b.HasIndex("cardItemsId");

                    b.ToTable("CardItemOrder");
                });
            ...
            modelBuilder.Entity("BurgerKingBackEnd.Entities.Card", b =>
                {
                    b.HasOne("BurgerKingBackEnd.Entities.Order", "Order")
                        .WithOne("Card")
                        .HasForeignKey("BurgerKingBackEnd.Entities.Card", "OrderId")
            ...
            modelBuilder.Entity("BurgerKingBackEnd.Entities.Courier", b =>
                {
                    b.HasOne("BurgerKingBackEnd.Entities.CustomUser", "CustomUser")
                        .WithOne("Courier")
                        .HasForeignKey("BurgerKingBackEnd.Entities.Courier", "CustomUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CardItemOrder", b =>
                {
                    b.HasOne("BurgerKingBackEnd.Entities.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BurgerKingBackEnd.Entities.CardItem", null)
                        .WithMany()
                        .HasForeignKey("cardItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BurgerKingBackEnd.Entities.CustomUser", null)
                        .WithMany()
